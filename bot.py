...
ALL_CITIES = DEFAULT_CITIES + [
    ...
    "Кемерово", "Новокузнецк", "Рязань", "Астрахань", "Набережные Челны", "Пенза",
    "Липецк", "Тула", "Киров", "Чебоксары", "Курск", "Магнитогорск", "Сочи", "Калининград",
    "Брянск", "Иваново", "Белгород", "Ставрополь", "Симферополь", "Севастополь", "Курган",
    "Архангельск", "Сургут", "Владимир", "Чита", "Смоленск", "Калуга", "Кострома", "Грозный",
    "Якутск", "Сыктывкар", "Мурманск", "Тамбов", "Химки", "Балашиха", "Подольск", "Королёв",
    "Мытищи", "Люберцы", "Энгельс", "Великий Новгород", "Псков", "Саранск", "Йошкар-Ола",
    "Кызыл", "Абакан", "Петрозаводск", "Северодвинск", "Норильск", "Ангарск", "Благовещенск",
    "Братск", "Великие Луки", "Волжский", "Гатчина", "Дзержинск", "Димитровград", "Евпатория",
    "Жигулёвск", "Златоуст", "Ивантеевка", "Ишим", "Каменск-Уральский", "Камышин", "Керчь",
    "Кисловодск", "Ковров", "Коломна", "Комсомольск-на-Амуре", "Кропоткин", "Кстово", "Кузнецк",
    "Кыштым", "Ленинск-Кузнецкий", "Магадан", "Междуреченск", "Мичуринск", "Муром", "Находка",
    "Нефтекамск", "Нефтеюганск", "Нижневартовск", "Нижнекамск", "Новороссийск", "Новотроицк",
    "Новочебоксарск", "Новошахтинск", "Ногинск", "Обнинск", "Озёрск", "Октябрьский", "Орёл",
    "Орск", "Павлово", "Петропавловск-Камчатский", "Прокопьевск", "Пятигорск", "Рубцовск",
    "Рыбинск", "Салават", "Северск", "Серпухов", "Сызрань", "Таганрог", "Тверь", "Тобольск",
    "Торжок", "Туапсе", "Уссурийск", "Ухта", "Феодосия", "Ханты-Мансийск", "Череповец",
    "Черкесск", "Шахты", "Щёлково", "Элиста", "Южно-Сахалинск", "Ялта", "Азов", "Алапаевск",
    "Алексин", "Альметьевск", "Анапа", "Апатиты", "Арзамас", "Армавир", "Артём", "Асбест",
    "Ачинск", "Балаково", "Балахна", "Балашов", "Белово", "Белорецк", "Белореченск", "Бердск",
    "Березники", "Бийск", "Бор", "Борисоглебск", "Будённовск", "Бузулук", "Верхняя Пышма",
    "Видное", "Вихоревка", "Вольск", "Воткинск", "Выборг", "Выкса", "Вязьма", "Глазов", "Губкин",
    "Гуково", "Дербент", "Дмитров", "Донской", "Дубна", "Егорьевск", "Ейск", "Елец", "Ессентуки",
    "Железногорск", "Жуковский", "Зеленоград", "Зерноград", "Ивантеевка", "Каменск-Шахтинский",
    "Канск", "Каспийск", "Кинешма", "Клин", "Клинцы", "Копейск", "Котельники", "Котлас",
    "Краснотурьинск", "Красный Сулин", "Крымск", "Кунгур", "Лабинск", "Лесосибирск", "Лобня",
    "Лыткарино", "Майкоп", "Минеральные Воды", "Михайловка", "Можайск", "Мончегорск", "Назрань",
    "Нальчик", "Нерюнгри", "Новодвинск", "Новомосковск", "Новочеркасск", "Ноябрьск", "Одинцово",
    "Оленегорск", "Онега", "Партизанск", "Петушки", "Печора", "Плесецк", "Покров", "Приозерск",
    "Прохладный", "Пушкино", "Раменское", "Ревда", "Реутов", "Ржев", "Родники", "Россошь",
    "Руза", "Ряжск", "Салехард", "Сафоново", "Свободный", "Северобайкальск", "Североморск",
    "Сергиев Посад", "Сертолово", "Сибай", "Славянск-на-Кубани", "Соликамск", "Солнечногорск",
    "Сосновый Бор", "Старый Оскол", "Стерлитамак", "Ступино", "Сызрань", "Тайга", "Тайшет",
    "Тара", "Татарск", "Тейково", "Тихвин", "Тихорецк", "Торжок", "Троицк", "Туймазы",
    "Туринск", "Тутаев", "Тында", "Углич", "Удачный", "Улан-Удэ", "Усинск", "Усолье-Сибирское",
    "Усть-Илимск", "Усть-Лабинск", "Фрязино", "Хасавюрт", "Хотьково", "Чайковский", "Чапаевск",
    "Черемхово", "Черногорск", "Чистополь", "Чкаловск", "Шадринск", "Шали", "Шебекино",
    "Шелехов", "Шуя", "Электросталь", "Юрга", "Ясногорск"
]
